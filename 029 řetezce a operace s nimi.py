...
# print(cislice)
# print(string.punctuation) #speciální znaky
...
ret.split(oddelovac,n) - vrátí seznam podřetězců, oddělovačem
...
"""
Úkol:
0) Načtěte řetězec a zjistěte, jestli obsahuje
   alespoň jeden speciální znak. Kód napište
   jako funkci Test_Sily_Hesla(heslo).
...
3) Načtěte od uživatele větu a vypočítejte 
   průměrnou délku jejích slov. Tečku za větou
   a mezery do délky nepočítejte.
"""
