...
2) Nastavte si proměnné a, b a c (délky stran 
   kvádru). Do proměnné objem spočítejte 
   objem kvádru. Výsledek vypište celou větou.

3) Převeďte číslo FAD z hexadecimálního na 
